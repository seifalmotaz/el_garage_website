...
export default function InspectionBanner() {
  return (
    <section className="relative w-full min-h-[400px] md:min-h-[449px] py-12 md:py-20  text-gray-900 md:text-white bg-white md:bg-transparent overflow-hidden select-none">
      <MaxWidthWrapper className="flex flex-col items-center justify-center">
        ...
        {/* Content wrapper */}
        <div className="relative z-20 w-full flex flex-col md:flex-row justify-start gap-8 items-center md:items-start">
          {/* Mobile Standalone Image Card - Mobile Only */}
          <div className="relative w-full h-[201px] rounded-[24px] overflow-hidden mb-6 md:hidden shadow-sm">
            <Image
              src="/assets/services_bg.png"
            ...
            <div className="flex flex-col gap-4.5 w-full">
              ...
              <div className="flex flex-col gap-3 md:gap-4 w-full">
                ...
                <p className="text-gray-500 md:text-white text-sm md:text-lg lg:text-[18px] font-medium leading-relaxed max-w-[549px]">
                  احصل على تقرير فحص شامل لأكثر من 200 نقطة من مفتشينا المعتمدين
                  قبل الشراء
                </p>
              </div>
            </div>
