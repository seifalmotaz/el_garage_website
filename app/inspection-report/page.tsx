...
const MOCK_CAR = {
  ...
  mileage: 48500,
  price: 1850000,
  images: ["/assets/why_cars.png", "/assets/car_placeholder.png"],
};
...
const MOCK_SECTIONS = [
  ...
  },
  {
    ...
    photos: [
      {
        url: "/assets/why_cars.png",
        description: "الجانب الأيمن للمركبة سليم بالكامل",
      },
      {
        url: "/assets/car_placeholder.png",
        description: "خدش بسيط ممتص الصدمات الخلفي",
      },
    ],
    sectionNote:
      "الهيكل الخارجي سليم بشكل عام مع وجود خدوش سطحية بسيطة تم توثيقها بالصور.",
    questions: [
      {
        id: "ext_1",
        label: "طلاء الهيكل الخارجي",
        desc: "فحص جودة الطلاء ووجود رش تجميلي",
        status: "GOOD",
        notes: "الطلاء أصلي بالكامل بدون أي رش تجميلي.",
      },
      {
        id: "ext_2",
        label: "الصدام الأمامي والخلفي",
        desc: "فحص الصدمات والخدوش والتثبيت",
        status: "WARN",
        notes: "وجود خدش سطحي بطول 5 سم في الجزء الأيسر للصدام الخلفي.",
      },
      {
        id: "ext_3",
        label: "الزجاج والشبابيك",
        desc: "فحص زجاج الأمامي والخلفي والجانبي من التشققات",
        status: "GOOD",
        notes: "الزجاج أصلي وخالٍ من أي شروخ.",
      },
      {
        id: "ext_4",
        label: "الأبواب وفتحة السقف",
        desc: "سلامة الفتح والغلق وموانع التسريب",
        status: "GOOD",
        notes: "فتحة السقف تعمل بسلاسة وموانع المياه سليمة.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "brk_1",
        label: "أقراص الفرامل (الطنابير)",
        desc: "قياس تآكل الأقراص وجودة السطح",
        status: "GOOD",
        notes: "الأقراص سليمة ولا تحتاج لتغيير حالياً.",
      },
      {
        id: "brk_2",
        label: "قماش وتيل الفرامل الأمامي",
        desc: "سماكة تيل الفرامل الأمامي وفعالية الكبح",
        status: "BAD",
        notes: "سماكة التيل أقل من 2 ملم. تالف ويحتاج تغيير فوري.",
      },
      {
        id: "brk_3",
        label: "قماش وتيل الفرامل الخلفي",
        desc: "سماكة تيل الفرامل الخلفي والفرامل اليدوية",
        status: "GOOD",
        notes: "حالة التيل الخلفي جيدة بنسبة 60%.",
      },
      {
        id: "brk_4",
        label: "سائل الفرامل ووصلات الخراطيم",
        desc: "فحص مستوى زيت الفرامل والتهريب",
        status: "GOOD",
        notes: "لا يوجد تهريب في الخراطيم ونسبة الرطوبة بالزيت مقبولة.",
      },
    ],
  },
  {
    ...
    photos: [
      {
        url: "/assets/car_placeholder.png",
        description: "فحص غرفة المحرك بالكامل",
      },
    ],
    sectionNote:
      "المحرك يعمل بكفاءة ممتازة، لا توجد أصوات غريبة أو تهريب سوائل أساسية.",
    questions: [
      {
        id: "eng_1",
        label: "أداء وسحب المحرك",
        desc: "كفاءة الاحتراق والسرعة المحددة",
        status: "GOOD",
        notes: "أداء المحرك متوازن ويفوق 94% من كفاءة المصنع.",
      },
      {
        id: "eng_2",
        label: "ناقل الحركة (الفتيس)",
        desc: "سلاسة النقل ونظام التبريد",
        status: "GOOD",
        notes: "التعشيقات والنقلات ناعمة بالكامل في مختلف السرعات.",
      },
      {
        id: "eng_3",
        label: "تهريب الزيوت والسوائل",
        desc: "تسريب زيت المحرك، الجير، المبرد",
        status: "GOOD",
        notes: "لا توجد أي علامات لتسريب الزيوت أو نقص سوائل المبرد.",
      },
      {
        id: "eng_4",
        label: "شمعات الاحتراق (البوجيهات)",
        desc: "حالة البوجيهات والأسلاك الكهربائية",
        status: "WARN",
        notes:
          "شمعات الاحتراق قاربت على انتهاء عمرها الافتراضي، ينصح بتغييرها بالصيانة القادمة.",
      },
    ],
  },
  {
    ...
    sectionNote:
      "المقصورة الداخلية نظيفة ومعقمة، شاشة العرض واللوحة الرئيسية تعمل بالكامل.",
    questions: [
      {
        id: "int_1",
        label: "نظام التكييف والتدفئة",
        desc: "قوة التبريد وتوزيع الهواء بالفوهات",
        status: "GOOD",
        notes: "التبريد ممتاز ومستوى غاز الفريون طبيعي.",
      },
      {
        id: "int_2",
        label: "شاشات العرض والعدادات",
        desc: "فحص شاشات الوسائط الترفيهية ولوحة العدادات",
        status: "GOOD",
        notes: "الشاشات تعمل باللمس بدون بكسلات تالفة أو تأخر استجابة.",
      },
      {
        id: "int_3",
        label: "كسوة المقاعد والأزرار",
        desc: "حالة مقاعد الجلد أو القماش، أزرار التحكم",
        status: "GOOD",
        notes: "المقاعد الجلدية نظيفة جداً وخالية من أي قطوع.",
      },
      {
        id: "int_4",
        label: "أحزمة الأمان والوسائد الهوائية",
        desc: "سلامة الأحزمة ولمبة تحذير الإيرباج",
        status: "GOOD",
        notes: "نظام الأمان مفعل ولا توجد لمبة تحذير إيرباج مضاءة.",
      },
    ],
  },
];
        ...
        <div className="max-w-[1200px] mx-auto px-4 flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="#" className="flex items-center gap-2 md:gap-3">
              ...
              <span className="font-bold text-sm md:text-lg text-primary-500">
                الجراج
              </span>
            </Link>
            ...
            <div className="flex items-center gap-3 md:gap-6">
              ...
              <div className="flex items-center gap-2">
                <div className="relative w-10 h-10 md:w-12 md:h-12 flex items-center justify-center">
                  ...
                  <span className="absolute text-[10px] md:text-xs font-black text-primary-500">
                    {passedRate}%
                  </span>
                </div>
        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          >
            ...
            <div className="border-b border-gray-100 pb-4 mb-6">
              <h1 className="text-2xl font-black text-primary-500 leading-tight">
                تقرير الفحص الفني المعتمد
              </h1>
              <p className="text-gray-500 text-sm mt-1">
                رقم التقرير:{" "}
                <span className="font-mono text-gray-800">#EGR-2026-9901</span>{" "}
                · تاريخ الفحص:{" "}
                <span className="font-bold text-gray-800">20 يونيو 2026</span>
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col justify-between">
                <h3 className="text-lg font-bold text-gray-800 mb-3">
                  {MOCK_CAR.brand} - {MOCK_CAR.model}
                </h3>

                <div className="grid grid-cols-2 gap-y-4 gap-x-2 border-t border-gray-100 pt-3">
                  <div className="flex flex-col">
                    <span className="text-xs text-gray-500 font-semibold mb-0.5">
                      سنة الموديل
                    </span>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-bold text-gray-800">
                      {MOCK_CAR.mileage.toLocaleString()} كم
                    </span>
                  </div>
                  <div className="flex flex-col border-t border-gray-100/50 pt-2">
                    ...
                    <span className="text-sm font-bold text-primary-500">
                      {MOCK_CAR.price.toLocaleString()} ر.س
                    </span>
                  </div>
                  <div className="flex flex-col border-t border-gray-100/50 pt-2">
                    <span className="text-xs text-gray-500 font-semibold mb-0.5">
          ...
          {/* Render Sections */}
          {MOCK_SECTIONS.filter((s) => s.questions.length > 0).map(
            (section) => {
                ...
                >
                  ...
                  <div className="flex items-center justify-between border-b border-gray-100 pb-3 mb-4">
                    ...
                    <span className="text-xs font-semibold text-gray-500">
                      {
                        section.questions.filter((q) => q.status === "GOOD")
                          .length
                      }{" "}
                      من {section.questions.length} بنود سليمة
                    </span>
                  </div>
                    ...
                    {section.photos.length > 0 ? (
                      ...
                      <div className="flex items-center gap-3 p-4 rounded-xl border border-dashed border-gray-300 bg-gray-50/50">
                        <div className="w-16 h-10 relative flex items-center justify-center opacity-40">
                          ...
                          >
                            <path
                              d="M3 8.5C3 8.5 3 6.5 4.5 6C6 5.5 8 3 11 3C14 3 17.5 5.5 19 6C20.5 6.5 21 8.5 21 8.5H3Z"
                              strokeWidth="1"
                            />
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[10px] text-gray-400">
                            لم يتم رصد أعطال أو أضرار تستدعي التصوير في هذا
                            القسم.
                          </span>
                        </div>
                      </div>
                        ...
                        return (
                          <div
                            ...
                            className={`flex items-start gap-3 p-3.5 rounded-xl border transition-all hover:shadow-md ${
                              isGood
                                ? "bg-green-50/20 border-green-100 hover:border-green-200"
                                : isWarn
                          ...
                          >
                            {/* SVG Status Icon */}
                            <div
                              className={`mt-0.5 shrink-0 w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs ${
                                isGood
                            ...
                            <div className="flex-1 flex flex-col">
                              ...
                              <span
                                className={`text-[10px] md:text-xs font-semibold mt-1.5 text-right ${
                                  isGood
                                    ? "text-green-700"
                                    : isWarn
                                      ? "text-amber-700"
        ...
        <div className="w-full lg:w-[350px] shrink-0 flex flex-col gap-6 lg:sticky lg:top-[160px] h-fit">
          ...
          <div className="bg-primary-50 rounded-2xl p-5 border border-primary-100 text-right shadow-sm">
            ...
            <p className="text-xs text-primary-800 leading-relaxed">
              المركبة في حالة عامة جيدة جداً ومطابقة لشروط الاستخدام الطبيعي.
              نوصي فقط بتغيير تيل الفرامل الأمامي بشكل عاجل، ومراقبة البوجيهات
              عند بلوغ الـ 50,000 كم.
            </p>
          </div>
