...
export default function Footer() {
  return (
    <footer id="footer" className="relative bg-gradient-to-t from-[#002853] to-[#002ec1] text-white select-none overflow-hidden">
      ...
      <div className="w-full bg-[#191919] py-4 px-6 border-t border-white/5 z-10 relative">
        <div className="max-w-[1336px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
